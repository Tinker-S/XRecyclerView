...
public class XRecyclerViewFooter extends LinearLayout {
    ...
    private void initView(Context context) {
        LinearLayout moreView = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.xrecyclerview_footer, null);
        addView(moreView);
        moreView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));

        mContentView = moreView.findViewById(R.id.content);
        mProgressBar = moreView.findViewById(R.id.progress);
        mHintView = (TextView) moreView.findViewById(R.id.hint);
    }
}